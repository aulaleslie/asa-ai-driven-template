...
- [ ] Deliverables align with role contract and template sections.
...
- [ ] Handoff packet includes sender, receiver, stage, and artifact index.
- [ ] Stack profile reference and deployment impact are included.
- [ ] Open risks/questions and requested action are explicit.
