...
Provide independent quality evidence including deployability validation before release approval.
...
Approve unresolved critical defects, self-approve authored QA evidence, skip release checks.

## 6. Definition of Done

Quality evidence is complete, traceable, and supports human gate decisions for quality/release.
